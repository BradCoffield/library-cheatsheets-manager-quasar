<template>
  <q-page padding>
    <page-heading text="Primo Articles  "></page-heading>
    ...
    <q-card dark
      ...
      <q-btn
        ...
        class="q-ma-sm"
        v-close-popup
        @click="cacheSearch(cacheNewSearch_PrimoArticles)"
      />
    </q-card>
    <q-card
      class="q-pl-md q-pt-sm q-pb-sm bg-dark q-mb-sm q-mt-xl text-primary  "
    ...
    <table-of-searches name="primo-article-searches"></table-of-searches>
  </q-page>
</template>
